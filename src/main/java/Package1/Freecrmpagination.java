...
public class Freecrmpagination {
 ...
 static WebDriver driver;
	public static void main(String[] args) {
		...
		List<WebElement>li=driver.findElements(By.xpath("(//div[@class='pagination'])[1]/a"));
		for(int i=0;i<li.size();i++)
		{
			
			if(driver.findElements(By.xpath("//td//a[text()='Mut Bonda']")).size()>0)
			{
				//driver.findElement(By.xpath("//td//a[text()='Mut Bonda']//parent::td//preceding-sibling::td/input")).click();
				clickelement("Mut Bonda");
			...
			{
				li=driver.findElements(By.xpath("(//div[@class='pagination'])[1]/a"));
				li.get(i).click();
			}
		}
	 ...
	 {
		 driver.findElement(By.xpath("//td//a[text()='"+name+"']//parent::td//preceding-sibling::td/input")).click();
	 }
